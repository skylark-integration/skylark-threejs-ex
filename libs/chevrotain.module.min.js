    ...
    !function (t, e) {
        ...
        return function (t) {
            ...
            function (t, e, n) {
                ...
                var r = n(1), i = function () {
                        ...
                        return t.prototype.visit = function (t) {
                            ...
                            if (t instanceof r.Flat)
                                return this.visitFlat(t);
            ...
            function (t, e, n) {
                'use strict';
                Object.defineProperty(e, '__esModule', { value: !0 });
                var r = n(0), i = 'MismatchedTokenException', o = 'NoViableAltException', a = 'EarlyExitException', s = 'NotAllInputParsedException', u = [
                        i,
                        o,
                        a,
                        s
            ...
            function (t, e, n) {
                ...
                e.isSequenceProd = function (t) {
                    ...
                    if (t instanceof a.NonTerminal)
                        return 'SUBRULE';
                    if (t instanceof a.Option)
                        return 'OPTION';
                    if (t instanceof a.Alternation)
                        return 'OR';
                    ...
                    if (t instanceof a.RepetitionWithSeparator)
                        return 'MANY_SEP';
                    if (t instanceof a.Repetition)
                        return 'MANY';
                    if (t instanceof a.Terminal)
                        return 'CONSUME';
                    throw Error('non exhaustive match');
                };
                var c = function (t) {
            ...
            function (t, e, n) {
                ...
                e.defaultParserErrorProvider = {
                    buildMismatchTokenMessage: function (t) {
                        ...
                        return 'Expecting ' + (r.hasTokenLabel(e) ? '--> ' + r.tokenLabel(e) + ' <--' : 'token of type --> ' + r.tokenName(e) + ' <--') + " but found --> '" + n.image + "' <--";
                    },
                    ...
                    buildAlternationPrefixAmbiguityError: function (t) {
                        var e = o.map(t.prefixPath, function (t) {
                                return r.tokenLabel(t);
                            }).join(', '), n = 0 === t.alternation.idx ? '' : t.alternation.idx;
                    ...
                    buildLeftRecursionError: function (t) {
                        ...
                        return 'Left Recursion found in grammar.\nrule: <' + e + '> can be invoked from itself (directly or indirectly)\nwithout consuming any Tokens. The grammar path that causes this is: \n ' + (e + ' --> ' + i.map(t.leftRecursionPath, function (t) {
                            return t.name;
            ...
            function (t, e, n) {
                ...
                e.validateGrammar = function (t, e, n, r, i, p) {
                    var h = o.map(t, function (t) {
                            return function (t, e) {
                                var n = new y();
                                t.accept(n);
                                var r = n.allProductions, i = o.groupBy(r, E), a = o.pick(i, function (t) {
                                        return t.length > 1;
                                    });
                                return o.map(o.values(a), function (n) {
                                    var r = o.first(n), i = e.buildDuplicateFoundError(t, n), a = u.getProductionDslName(r), c = {
                                            message: i,
                ...
                function R(t, e, n, r) {
                    ...
                    var c = o.difference(a, r.concat([t])), p = o.map(c, function (e) {
                            var i = o.cloneArr(r);
                ...
                function k(t, e, n) {
                    ...
                    return a.forEach(t, function (t) {
                        ...
                        a.forEach(o, function (i) {
                            var o = p.getProdType(i), u = i.idx, c = p.getLookaheadPathsForOptionalProd(u, t, o, e)[0];
            ...
            function (t, e, n) {
                ...
                !function (t) {
                    ...
                    if (t instanceof p.Option)
                        return o.OPTION;
                    if (t instanceof p.Repetition)
                        return o.REPETITION;
                    ...
                    var a = m(t, e, i, n), s = T(a) ? c.tokenStructuredMatcherNoCategories : c.tokenStructuredMatcher;
                    return o(a[0], s, r);
            ...
            function (t, e, n) {
                ...
                Object.defineProperty(e, '__esModule', { value: !0 });
                var o = n(14), a = n(0), s = n(2), u = n(21), c = n(1), p = function (t) {
                        function e(e, n) {
                            var r = t.call(this) || this;
                ...
                var f = function (t) {
                    ...
                    return i(e, t), e.prototype.walkMany = function (e, n, r) {
                        if (e.idx === this.occurrence) {
                            ...
                            t.prototype.walkMany.call(this, e, n, r);
                    }, e;
                }(h);
                ...
                var d = function (t) {
                    ...
                    return i(e, t), e.prototype.walkManySep = function (e, n, r) {
                        if (e.idx === this.occurrence) {
                            ...
                            t.prototype.walkManySep.call(this, e, n, r);
                    }, e;
                }(h);
                ...
                var E = function (t) {
                    ...
                    return i(e, t), e.prototype.walkAtLeastOne = function (e, n, r) {
                        if (e.idx === this.occurrence) {
                            ...
                            t.prototype.walkAtLeastOne.call(this, e, n, r);
                    }, e;
                }(h);
                ...
                e.NextTerminalAfterAtLeastOneSepWalker = m, e.possiblePathsFrom = function t(e, n, r) {
                    ...
                    var i = ['EXIT_NONE_TERMINAL'], o = !1, s = e.length, u = s - r - 1, p = [], l = [];
                    for (l.push({
                            idx: -1,
                            def: t,
                            ruleStack: [],
                            ...
                            if (!a.isEmpty(f)) {
                                ...
                                if ('EXIT_NONE_TERMINAL' === T) {
                                    ...
                                    A = {
                                        ...
                                        ruleStack: E,
                                        occurrenceStack: m
                                    }, l.push(A), l.push('EXIT_ALTERNATIVE'), S = new c.Terminal({ terminalType: T.separator });
            ...
            function (t, e, n) {
                ...
                var u = function () {
                    function t(t, e) {
                        var n = this;
                        if (void 0 === e && (e = s), this.lexerDefinition = t, this.lexerDefinitionErrors = [], this.lexerDefinitionWarning = [], this.patternIdxToConfig = {}, this.charCodeToPatternIdxToConfig = {}, this.modes = [], this.emptyGroups = {}, this.config = void 0, this.trackStartLines = !0, this.trackEndLines = !0, this.hasCustom = !1, this.canModeBeOptimized = {}, 'boolean' == typeof e)
                    ...
                    return t.prototype.tokenize = function (t, e) {
                        ...
                        var n, o, a, s, u, c, p, l, h, f, d, E, m = this, y = t, T = y.length, v = 0, g = 0, _ = this.hasCustom ? 0 : Math.floor(t.length / 10), R = new Array(_), A = [], N = this.trackStartLines ? 1 : void 0, O = this.trackStartLines ? 1 : void 0, S = r.cloneEmptyGroups(this.emptyGroups), I = this.trackStartLines, L = this.config.lineTerminatorsPattern, k = 0, P = [], x = [], C = [], M = [];
                        Object.freeze(M);
                        var F, b = void 0, D = function (t) {
                        ...
                        if (!0 === t.pop) {
                            ...
                            void 0 !== t.push && n.call(this, t.push);
            ...
            function (t, e, n) {
                ...
                'undefined' != typeof self && self, i = [], void 0 === (o = 'function' == typeof (r = function () {
                    ...
                    t.prototype.saveState = function () {
                        ...
                        if (!0 !== t || void 0 !== e)
                            return u(e), '?' === this.peekChar(0) ? (this.consumeChar('?'), e.greedy = !1) : e.greedy = !0, e.type = 'Quantifier', e;
            ...
            function (t, e, n) {
                'use strict';
                Object.defineProperty(e, '__esModule', { value: !0 }), e.defaultLexerErrorProvider = {
            ...
            function (t, e, n) {
                ...
                function a(t) {
                    if (t instanceof i.NonTerminal)
                        return a(t.referencedRule);
                    if (t instanceof i.Terminal)
                        return c(t);
                    if (o.isSequenceProd(t))
                        return s(t);
                    if (o.isBranchingProd(t))
                        return u(t);
                    throw Error('non exhaustive match');
                }
                function s(t) {
            ...
            function (t, e, n) {
                ...
                function C(t, n, i) {
                    ...
                    case r.REF:
                        return function (t) {
                            var e = l.exec(t.text), n = void 0 === e[1] ? 0 : parseInt(e[1], 10), r = e[2];
                    ...
                    case r.TERMINAL:
                        return function (t, n) {
                            var r = c.exec(t.text), i = void 0 === r[1] ? 0 : parseInt(r[1], 10), o = r[2], s = e.terminalNameToConstructor[o];
                            if (!s)
                ...
                function F(t, n, r, i, a) {
                    var s = i.exec(t.text), u = void 0 === s[1] ? 0 : parseInt(s[1], 10), c = s[3], p = e.terminalNameToConstructor[c];
                    if (!p)
                ...
                function D(t, e) {
                    return o.filter(e, function (n) {
                        var r = t.strictlyContainsRange(n.range), i = o.every(e, function (e) {
                                var r = e.range.strictlyContainsRange(n.range), i = e.range.isStrictlyContainedInRange(t);
                                return !(r && i);
                            });
                        return r && i;
                    });
                ...
                function V(t) {
                    var e = Y(t), n = H(t), r = X(t), i = z(t), o = q(t), a = $(t), s = Z(t), u = Q(t);
            ...
            function (t, e, n) {
                ...
                function l(t, e, n, i, o, a) {
                    var s = this.getKeyForAutomaticLookahead(i, o), u = this.firstAfterRepMap.get(s);
                    if (void 0 === u) {
            ...
            function (t, e, n) {
                ...
                Object.defineProperty(e, '__esModule', { value: !0 });
                var o = n(14), a = n(4), s = n(21), u = n(0), c = n(22), p = n(2), l = n(1), h = function (t) {
                        function e(e) {
                            var n = t.call(this) || this;
                        ...
                        return i(e, t), e.prototype.startWalking = function () {
                            ...
                            var r = f(t.referencedRule, t.idx) + this.topProd.name, i = e.concat(n), o = new l.Flat({ definition: i }), a = s.first(o);
            ...
            function (t, e, n) {
                ...
                e.DEFAULT_MODE = 'defaultMode', e.MODES = 'modes', e.SUPPORT_STICKY = 'boolean' == typeof new RegExp('(?:)').sticky, e.disableSticky = function () {
                    ...
                    var r = u.reject(t, function (t) {
                            ...
                            if (u.isRegExp(e)) {
                                var r = e.source;
                                return 1 === r.length && '^' !== r && '$' !== r && '.' !== r ? r : 2 !== r.length || '\\' !== r[0] || u.contains([
                                    'd',
                                    'D',
                                    's',
                                    'S',
                ...
                function A(t) {
                    var e = [], n = u.reduce(t, function (t, e, n) {
                            ...
                            return i === s.Lexer.NA ? t : (u.isString(i) ? t.push({
                                ...
                                idx: n,
                                tokenType: e
                            }) : u.isRegExp(i) && (r = i, void 0 === u.find([
                                '.',
                                '\\',
                                '[',
                                ']',
                ...
                e.findStartOfInputAnchor = T, e.findUnsupportedFlags = v, e.findDuplicatePatterns = g, e.findInvalidGroupType = _, e.findModesThatDoNotExist = R, e.findUnreachablePatterns = A, e.addStartOfInput = N, e.addStickyFlag = O, e.performRuntimeChecks = function (t, n, r) {
                    ...
                    return e && u.forEach(a, function (t) {
                        ...
                        if (!1 !== e) {
                            ...
                            u.has(t, 'LINE_BREAKS') ? !0 === t.LINE_BREAKS && (i = !0) : c.canMatchCharCode(p, t.PATTERN) && (i = !0);
                    }), e && !i && r.push({
            ...
            function (t, e, n) {
                'use strict';
                Object.defineProperty(e, '__esModule', { value: !0 });
                var r = n(12), i = n(0), o = n(3), a = n(9), s = function () {
                        function t() {
                        }
                        return t.prototype.initLooksAhead = function (t) {
                            ...
                            var n = this.getKeyForAutomaticLookahead(a.OR_IDX, t), o = this.getLaFuncFromCache(n);
                            if (void 0 === o) {
            ...
            function (t, e, n) {
                'use strict';
                Object.defineProperty(e, '__esModule', { value: !0 });
                var r = n(16), i = n(0), o = n(33), a = n(9), s = n(3), u = function () {
                        function t() {
                        }
                        return t.prototype.initTreeBuilder = function (t) {
                            ...
                            var i, o = this.getLastExplicitRuleShortName(), s = a.getKeyForAltIndex(o, n, e, r);
            ...
            function (t, e, n) {
                'use strict';
                Object.defineProperty(e, '__esModule', { value: !0 });
                var r = n(0), i = n(6), o = n(3), a = n(10), s = n(23), u = n(11), c = n(1), p = function () {
                        function t() {
                        }
            ...
            function (t, e, n) {
                'use strict';
                Object.defineProperty(e, '__esModule', { value: !0 });
                var r = n(0), i = n(9), o = n(6), a = n(12), s = n(13), u = n(3), c = n(25), p = n(2), l = n(7), h = n(4), f = function () {
                        function t() {
                        }
                        return t.prototype.initRecognizerEngine = function (t, e) {
                            ...
                            var a, s = r.has(n, 'resyncEnabled') ? n.resyncEnabled : u.DEFAULT_RULE_CONFIG.resyncEnabled, c = r.has(n, 'recoveryValueFunc') ? n.recoveryValueFunc : u.DEFAULT_RULE_CONFIG.recoveryValueFunc, p = this.ruleShortNameIdx << i.BITS_FOR_METHOD_IDX + i.BITS_FOR_OCCURRENCE_IDX;
                            ...
                            var n = this.getKeyForAutomaticLookahead(i.OPTION_IDX, e), r = this.nestedRuleBeforeClause(t, n);
                            try {
                            ...
                            var n = this.getKeyForAutomaticLookahead(i.AT_LEAST_ONE_IDX, t), r = this.nestedRuleBeforeClause(e, n);
                            try {
                            ...
                            this.attemptInRepetitionRecovery(this.atLeastOneInternal, [
                                t,
                                e
                            ], c, i.AT_LEAST_ONE_IDX, t, s.NextTerminalAfterAtLeastOneWalker);
                        }, t.prototype.atLeastOneSepFirstInternal = function (t, e) {
                            var n = this.getKeyForAutomaticLookahead(i.AT_LEAST_ONE_SEP_IDX, t), r = this.nestedRuleBeforeClause(e, n);
                            try {
                            ...
                            ], c, i.AT_LEAST_ONE_SEP_IDX, t, s.NextTerminalAfterAtLeastOneSepWalker);
                        }, t.prototype.manyInternal = function (t, e) {
                            var n = this.getKeyForAutomaticLookahead(i.MANY_IDX, t), r = this.nestedRuleBeforeClause(e, n);
                            try {
                            ...
                            this.attemptInRepetitionRecovery(this.manyInternal, [
                                t,
                                e
                            ], u, i.MANY_IDX, t, s.NextTerminalAfterManyWalker);
                        }, t.prototype.manySepFirstInternal = function (t, e) {
                            var n = this.getKeyForAutomaticLookahead(i.MANY_SEP_IDX, t), r = this.nestedRuleBeforeClause(e, n);
                            try {
                            ...
                            if (!0 === this.getLookaheadFuncForManySep(n, t).call(this)) {
                                ...
                                ], u, i.MANY_SEP_IDX, t, s.NextTerminalAfterManySepWalker);
                            }
                            ...
                            var n = r.isArray(t) ? t : t.DEF, i = this.getLookaheadFuncForOr(e, n).call(this, n);
                            if (void 0 !== i)
                                return n[i].ALT.call(this);
                            this.raiseNoAltException(e, t.ERR_MSG);
                        }, t.prototype.orInternal = function (t, e) {
                            var n = this.getKeyForAutomaticLookahead(i.OR_IDX, e), o = this.nestedRuleBeforeClause(t, n);
                            try {
            ...
            function (t, e, n) {
                'use strict';
                Object.defineProperty(e, '__esModule', { value: !0 });
                var r = n(6), i = n(0), o = n(12), a = n(3), s = function () {
                        function t() {
                        }
                        return t.prototype.initErrorHandler = function (t) {
                            ...
                            for (var n = this.getCurrRuleFullName(), i = this.getGAstProductions().get(n), a = o.getLookaheadPathsForOr(t, i, this.maxLookahead), s = [], u = 1; u <= this.maxLookahead; u++)
                                s.push(this.LA(u));
                            var c = this.LA(0), p = this.errorMessageProvider.buildNoViableAltMessage({
            ...
            function (t, e, n) {
                ...
                e.createSyntaxDiagramsCode = function (t, e) {
                    var n = void 0 === e ? {} : e, i = n.resourceBase, o = void 0 === i ? 'https://unpkg.com/chevrotain@' + r.VERSION + '/diagrams/' : i, a = n.css;
            ...
            function (t, e, n) {
                ...
                function m(t, e) {
                    ...
                    return r.forEach(t, function (t) {
                        n += function (t, e) {
                            if (t instanceof o.NonTerminal)
                                return l(t, e);
                            if (t instanceof o.Option)
                                return d('OPTION', t, e);
                            ...
                            if (t instanceof o.Repetition)
                                return d('MANY', t, e);
                            if (t instanceof o.Alternation)
                                return h(t, e);
                            if (t instanceof o.Terminal)
                                return p(t, e);
                            if (t instanceof o.Flat)
                                return m(t.definition, e);
                            throw Error('non exhaustive match');
                        }(t, e + 1);
                    }), n;
                }
