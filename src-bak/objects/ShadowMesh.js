define(["skylark-threejs"], function (a) {
    ...
    var ShadowMesh = function (mesh) {
        var shadowMaterial = new a.MeshBasicMaterial({
            color: 0,
            transparent: true,
            opacity: 0.6,
            depthWrite: false
        });
        a.Mesh.call(this, mesh.geometry, shadowMaterial);
        this.meshMatrix = mesh.matrixWorld;
        this.frustumCulled = false;
        this.matrixAutoUpdate = false;
    };
    ShadowMesh.prototype = Object.create(a.Mesh.prototype);
    ShadowMesh.prototype.constructor = ShadowMesh;
    ShadowMesh.prototype.update = function () {
        var shadowMatrix = new a.Matrix4();
