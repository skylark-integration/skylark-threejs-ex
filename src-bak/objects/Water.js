define(["skylark-threejs"], function (a) {
    ...
    var Water = function (geometry, options) {
        ...
        var sunDirection = options.sunDirection !== undefined ? options.sunDirection : new a.Vector3(0.70707, 0.70707, 0);
        var sunColor = new a.Color(options.sunColor !== undefined ? options.sunColor : 16777215);
        var waterColor = new a.Color(options.waterColor !== undefined ? options.waterColor : 8355711);
        var eye = options.eye !== undefined ? options.eye : new a.Vector3(0, 0, 0);
        var distortionScale = options.distortionScale !== undefined ? options.distortionScale : 20;
        var side = options.side !== undefined ? options.side : a.FrontSide;
        var fog = options.fog !== undefined ? options.fog : false;
        var mirrorPlane = new a.Plane();
        var normal = new a.Vector3();
        var mirrorWorldPosition = new a.Vector3();
        ...
        var mirrorCamera = new a.PerspectiveCamera();
        var parameters = {
        ...
        var mirrorShader = {
            uniforms: a.UniformsUtils.merge([
                ...
                a.UniformsLib['lights'],
                {
                    ...
                    'textureMatrix': { value: new a.Matrix4() },
                    'sunColor': { value: new a.Color(8355711) },
                    'sunDirection': { value: new a.Vector3(0.70707, 0.70707, 0) },
                    'eye': { value: new a.Vector3() },
                    'waterColor': { value: new a.Color(5592405) }
                }
            ]),
            vertexShader: [
        ...
        var material = new a.ShaderMaterial({
            ...
            uniforms: a.UniformsUtils.clone(mirrorShader.uniforms),
            lights: true,
            side: side,
            fog: fog
        });
    ...
    Water.prototype = Object.create(a.Mesh.prototype);
