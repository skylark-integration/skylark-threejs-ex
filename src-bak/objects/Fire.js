define(["skylark-threejs"], function (a) {
    ...
    var Fire = function (geometry, options) {
        ...
        this.color1 = options.color1 || new a.Color(16777215);
        this.color2 = options.color2 || new a.Color(16752640);
        this.color3 = options.color3 || new a.Color(0);
        ...
        this.windVector = options.windVector || new a.Vector2(0, 0.75);
        ...
        this.field0 = new a.WebGLRenderTarget(textureWidth, textureHeight, parameters);
        this.field0.background = new a.Color(0);
        this.field1 = new a.WebGLRenderTarget(textureWidth, textureHeight, parameters);
        this.field0.background = new a.Color(0);
        this.fieldProj = new a.WebGLRenderTarget(textureWidth, textureHeight, parameters);
        this.field0.background = new a.Color(0);
        ...
        this.fieldScene = new a.Scene();
        this.fieldScene.background = new a.Color(0);
        this.orthoCamera = new a.OrthographicCamera(textureWidth / -2, textureWidth / 2, textureHeight / 2, textureHeight / -2, 1, 2);
        this.orthoCamera.position.z = 1;
        this.fieldGeometry = new a.PlaneBufferGeometry(textureWidth, textureHeight);
        this.internalSource = new a.DataTexture(this.sourceData, textureWidth, textureHeight, a.RGBAFormat);
        var shader = Fire.SourceShader;
        this.sourceMaterial = new a.ShaderMaterial({
        ...
        this.clearSources();
        this.sourceMesh = new a.Mesh(this.fieldGeometry, this.sourceMaterial);
        this.fieldScene.add(this.sourceMesh);
        var shader = Fire.DiffuseShader;
        this.diffuseMaterial = new a.ShaderMaterial({
            uniforms: shader.uniforms,
            vertexShader: shader.vertexShader,
            fragmentShader: shader.fragmentShader,
            transparent: false
        ...
        this.diffuseMesh = new a.Mesh(this.fieldGeometry, this.diffuseMaterial);
        this.fieldScene.add(this.diffuseMesh);
        shader = Fire.DriftShader;
        this.driftMaterial = new a.ShaderMaterial({
            uniforms: shader.uniforms,
            vertexShader: shader.vertexShader,
            fragmentShader: shader.fragmentShader,
            transparent: false
        ...
        this.driftMesh = new a.Mesh(this.fieldGeometry, this.driftMaterial);
        this.fieldScene.add(this.driftMesh);
        shader = Fire.ProjectionShader1;
        this.projMaterial1 = new a.ShaderMaterial({
            uniforms: shader.uniforms,
            vertexShader: shader.vertexShader,
            fragmentShader: shader.fragmentShader,
            transparent: false
        ...
        this.projMesh1 = new a.Mesh(this.fieldGeometry, this.projMaterial1);
        this.fieldScene.add(this.projMesh1);
        shader = Fire.ProjectionShader2;
        this.projMaterial2 = new a.ShaderMaterial({
            uniforms: shader.uniforms,
            vertexShader: shader.vertexShader,
            fragmentShader: shader.fragmentShader,
            transparent: false
        ...
        this.projMesh2 = new a.Mesh(this.fieldGeometry, this.projMaterial2);
        this.fieldScene.add(this.projMesh2);
        shader = Fire.ProjectionShader3;
        this.projMaterial3 = new a.ShaderMaterial({
            uniforms: shader.uniforms,
            vertexShader: shader.vertexShader,
            fragmentShader: shader.fragmentShader,
            transparent: false
        ...
        this.projMesh3 = new a.Mesh(this.fieldGeometry, this.projMaterial3);
        ...
        this.onBeforeRender = function (renderer) {
            ...
            renderer.toneMapping = a.NoToneMapping;
            this.sourceMesh.visible = false;
            this.diffuseMesh.visible = false;
            this.driftMesh.visible = false;
            this.projMesh1.visible = false;
            ...
            this.material.minFilter = a.LinearFilter, this.material.magFilter = a.LinearFilter, this.restoreRenderState(renderer);
        };
    };
    Fire.prototype = Object.create(a.Mesh.prototype);
    ...
    Fire.DriftShader = {
        uniforms: {
            'oneOverWidth': { value: null },
            'oneOverHeight': { value: null },
            'windVector': { value: new a.Vector2(0, 0) },
            'airSpeed': { value: null },
            'densityMap': { value: null }
        },
        vertexShader: [
