define([
    ...
    var Water = function (geometry, options) {
        ...
        var scope = this;
        options = options || {};
        var color = options.color !== undefined ? new a.Color(options.color) : new a.Color(16777215);
        var textureWidth = options.textureWidth || 512;
        var textureHeight = options.textureHeight || 512;
        var clipBias = options.clipBias || 0;
        var flowDirection = options.flowDirection || new a.Vector2(1, 0);
        ...
        if (b.Reflector === undefined) {
            console.error('THREE.Water: Required component Reflector not found.');
            return;
        }
        if (c.Refractor === undefined) {
            console.error('THREE.Water: Required component Refractor not found.');
            return;
        }
        var reflector = new b.Reflector(geometry, {
            textureWidth: textureWidth,
            textureHeight: textureHeight,
            clipBias: clipBias,
            encoding: encoding
        });
        var refractor = new c.Refractor(geometry, {
            textureWidth: textureWidth,
            textureHeight: textureHeight,
            clipBias: clipBias,
            encoding: encoding
        ...
        normalMap0.wrapS = normalMap0.wrapT = a.RepeatWrapping;
        normalMap1.wrapS = normalMap1.wrapT = a.RepeatWrapping;
