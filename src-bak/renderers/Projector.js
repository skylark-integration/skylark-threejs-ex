define(["skylark-threejs"], function (a) {
    ...
    var RenderableFace = function () {
        ...
        this.normalModel = new a.Vector3();
    ...
    var RenderableVertex = function () {
        ...
        this.positionScreen = new a.Vector4();
        this.visible = true;
    };
    ...
    var Projector = function () {
        var _object, _objectCount, _objectPool = [], _objectPoolLength = 0, _vertex, _vertexCount, _vertexPool = [], _vertexPoolLength = 0, _face, _faceCount, _facePool = [], _facePoolLength = 0, _line, _lineCount, _linePool = [], _linePoolLength = 0, _sprite, _spriteCount, _spritePool = [], _spritePoolLength = 0, _renderData = {
                ...
                lights: [],
                elements: []
            }, _vector3 = new a.Vector3(), _vector4 = new a.Vector4(), _clipBox = new a.Box3(new a.Vector3(-1, -1, -1), new a.Vector3(1, 1, 1)), _boundingBox = new a.Box3(), _points3 = new Array(3), _viewMatrix = new a.Matrix4(), _viewProjectionMatrix = new a.Matrix4(), _modelMatrix, _modelViewProjectionMatrix = new a.Matrix4(), _normalMatrix = new a.Matrix3(), _frustum = new a.Frustum(), _clippedVertex1PositionScreen = new a.Vector4(), _clippedVertex2PositionScreen = new a.Vector4();
        ...
        var RenderList = function () {
            ...
            var uvs = [];
            var object = null;
            var normalMatrix = new a.Matrix3();
            ...
            function pushTriangle(a, b, c, material) {
                ...
                if (checkTriangleVisibility(v1, v2, v3) === false)
                    return;
                if (material.side === a.DoubleSide || checkBackfaceCulling(v1, v2, v3) === true) {
        ...
        function projectObject(object) {
            if (object.visible === false)
                return;
            if (object instanceof a.Light) {
                _renderData.lights.push(object);
            } else if (object instanceof a.Mesh || object instanceof a.Line || object instanceof a.Points) {
                if (object.material.visible === false)
                    return;
                if (object.frustumCulled === true && _frustum.intersectsObject(object) === false)
                    return;
                addObject(object);
            } else if (object instanceof a.Sprite) {
                if (object.material.visible === false)
                    return;
        ...
        this.projectScene = function (scene, camera, sortObjects, sortElements) {
            ...
            for (var o = 0, ol = objects.length; o < ol; o++) {
                ...
                _vertexCount = 0;
                if (object instanceof a.Mesh) {
                    if (geometry instanceof a.BufferGeometry) {
                    ...
                    } else if (geometry instanceof a.Geometry) {
                        ...
                        for (var f = 0, fl = faces.length; f < fl; f++) {
                            ...
                            if (side !== a.DoubleSide) {
                                if (side === a.FrontSide && visible === false)
                                    continue;
                                if (side === a.BackSide && visible === true)
                                    continue;
                            }
                            _face = getNextFaceInPool();
                            _face.id = object.id;
                            ...
                            if (visible === false && (side === a.BackSide || side === a.DoubleSide)) {
                ...
                } else if (object instanceof a.Line) {
                    ...
                    if (geometry instanceof a.BufferGeometry) {
                        ...
                        if (attributes.position !== undefined) {
                            ...
                            if (geometry.index !== null) {
                                ...
                                var step = object instanceof a.LineSegments ? 2 : 1;
                ...
                } else if (object instanceof a.Points) {
                    _modelViewProjectionMatrix.multiplyMatrices(_viewProjectionMatrix, _modelMatrix);
                    if (geometry instanceof a.Geometry) {
                        var vertices = object.geometry.vertices;
                        for (var v = 0, vl = vertices.length; v < vl; v++) {
                            var vertex = vertices[v];
                    ...
                    } else if (geometry instanceof a.BufferGeometry) {
                        var attributes = geometry.attributes;
                        if (attributes.position !== undefined) {
                            var positions = attributes.position.array;
                            for (var i = 0, l = positions.length; i < l; i += 3) {
