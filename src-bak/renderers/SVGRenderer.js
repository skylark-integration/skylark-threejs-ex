define([
    ...
    SVGObject.prototype = Object.create(a.Object3D.prototype);
    SVGObject.prototype.constructor = SVGObject;
    var SVGRenderer = function () {
        var _this = this, _renderData, _elements, _lights, _projector = new b.Projector(), _svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg'), _svgWidth, _svgHeight, _svgWidthHalf, _svgHeightHalf, _v1, _v2, _v3, _clipBox = new a.Box2(), _elemBox = new a.Box2(), _color = new a.Color(), _diffuseColor = new a.Color(), _ambientLight = new a.Color(), _directionalLights = new a.Color(), _pointLights = new a.Color(), _clearColor = new a.Color(), _vector3 = new a.Vector3(), _centroid = new a.Vector3(), _normal = new a.Vector3(), _normalViewMatrix = new a.Matrix3(), _viewMatrix = new a.Matrix4(), _viewProjectionMatrix = new a.Matrix4(), _svgPathPool = [], _svgNode, _pathCount = 0, _currentPath, _currentStyle, _quality = 1, _precision = null;
        ...
        this.render = function (scene, camera) {
            if (camera instanceof a.Camera === false) {
            ...
            for (var e = 0, el = _elements.length; e < el; e++) {
                ...
                if (material === undefined || material.opacity === 0)
                    continue;
                _elemBox.makeEmpty();
                if (element instanceof b.RenderableSprite) {
                    _v1 = element;
                    _v1.x *= _svgWidthHalf;
                    _v1.y *= -_svgHeightHalf;
                    renderSprite(_v1, element, material);
                } else if (element instanceof b.RenderableLine) {
                    _v1 = element.v1;
                    _v2 = element.v2;
                ...
                } else if (element instanceof b.RenderableFace) {
                    _v1 = element.v1;
                    _v2 = element.v2;
                    _v3 = element.v3;
