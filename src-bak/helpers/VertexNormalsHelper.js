define(["skylark-threejs"], function (a) {
    'use strict';
    var _v1 = new a.Vector3();
    var _v2 = new a.Vector3();
    var _normalMatrix = new a.Matrix3();
    var _keys = [
        'a',
        'b',
        'c'
    ...
    function VertexNormalsHelper(object, size, hex, linewidth) {
        ...
        var positions = new a.Float32BufferAttribute(nNormals * 2 * 3, 3);
        geometry.setAttribute('position', positions);
        a.LineSegments.call(this, geometry, new a.LineBasicMaterial({
            color: color,
            linewidth: width
        }));
    ...
    VertexNormalsHelper.prototype = Object.create(a.LineSegments.prototype);
