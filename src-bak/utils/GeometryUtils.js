define(["skylark-threejs"], function (a) {
    ...
    var GeometryUtils = {
        hilbert2D: function (center, size, iterations, v0, v1, v2, v3) {
            var center = center !== undefined ? center : new a.Vector3(0, 0, 0), size = size !== undefined ? size : 10, half = size / 2, iterations = iterations !== undefined ? iterations : 1, v0 = v0 !== undefined ? v0 : 0, v1 = v1 !== undefined ? v1 : 1, v2 = v2 !== undefined ? v2 : 2, v3 = v3 !== undefined ? v3 : 3;
            var vec_s = [
                new a.Vector3(center.x - half, center.y, center.z - half),
                new a.Vector3(center.x - half, center.y, center.z + half),
                new a.Vector3(center.x + half, center.y, center.z + half),
                new a.Vector3(center.x + half, center.y, center.z - half)
            ];
