define([
    ...
    '../libs/motion-controllers.module.js'
], function (a, b, MotionControllerConstants, c) {
    'use strict';
    ...
    XRControllerModel.prototype = Object.assign(Object.create(a.Object3D.prototype), {
        ...
        updateMatrixWorld: function (force) {
            a.Object3D.prototype.updateMatrixWorld.call(this, force);
            ...
            Object.values(this.motionController.components).forEach(component => {
                Object.values(component.visualResponses).forEach(visualResponse => {
                    ...
                    if (valueNodeProperty === MotionControllerConstants.VisualResponseProperty.VISIBILITY) {
                        ...
                        a.Quaternion.slerp(minNode.quaternion, maxNode.quaternion, valueNode.quaternion, value);
        ...
        Object.values(motionController.components).forEach(component => {
            ...
            if (type === MotionControllerConstants.ComponentType.TOUCHPAD) {
                ...
                if (component.touchPointNode) {
                    const sphereGeometry = new a.SphereGeometry(0.001);
                    const material = new a.MeshBasicMaterial({ color: 255 });
                    const sphere = new a.Mesh(sphereGeometry, material);
    ...
    var XRControllerModelFactory = function () {
        function XRControllerModelFactory(gltfLoader = null) {
            ...
            this._assetCache = {};
            if (!this.gltfLoader) {
                this.gltfLoader = new b.GLTFLoader();
            }
        }
            ...
            createControllerModel: function (controller) {
                ...
                controller.addEventListener('connected', event => {
                    ...
                    if (xrInputSource.targetRayMode !== 'tracked-pointer' || !xrInputSource.gamepad)
                        return;
                    c.fetchProfile(xrInputSource, this.path, DEFAULT_PROFILE).then(({profile, assetPath}) => {
