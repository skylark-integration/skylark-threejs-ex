define([
    ...
    Volume.prototype = {
        ...
        extractPerpendicularPlane: function (axis, RASIndex) {
            var iLength, jLength, sliceAccess, planeMatrix = new a.Matrix4().identity(), volume = this, planeWidth, planeHeight, firstSpacing, secondSpacing, positionOffset, IJKIndex;
            var axisInIJK = new a.Vector3(), firstDirection = new a.Vector3(), secondDirection = new a.Vector3();
            var dimensions = new a.Vector3(this.xLength, this.yLength, this.zLength);
            switch (axis) {
            case 'x':
                axisInIJK.set(1, 0, 0);
                ...
                IJKIndex = new a.Vector3(RASIndex, 0, 0);
                planeMatrix.multiply(new a.Matrix4().makeRotationY(Math.PI / 2));
                positionOffset = (volume.RASDimensions[0] - 1) / 2;
                planeMatrix.setPosition(new a.Vector3(RASIndex - positionOffset, 0, 0));
                break;
            case 'y':
                axisInIJK.set(0, 1, 0);
                ...
                IJKIndex = new a.Vector3(0, RASIndex, 0);
                planeMatrix.multiply(new a.Matrix4().makeRotationX(-Math.PI / 2));
                positionOffset = (volume.RASDimensions[1] - 1) / 2;
                planeMatrix.setPosition(new a.Vector3(0, RASIndex - positionOffset, 0));
                break;
            case 'z':
            default:
                axisInIJK.set(0, 0, 1);
                ...
                firstSpacing = this.spacing[0];
                secondSpacing = this.spacing[1];
                IJKIndex = new a.Vector3(0, 0, RASIndex);
                positionOffset = (volume.RASDimensions[2] - 1) / 2;
                planeMatrix.setPosition(new a.Vector3(0, 0, RASIndex - positionOffset));
                break;
            }
        ...
        extractSlice: function (axis, index) {
            var slice = new b.VolumeSlice(this, index, axis);
