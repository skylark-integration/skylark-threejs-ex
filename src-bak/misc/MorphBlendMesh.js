define(["skylark-threejs"], function (a) {
    ...
    MorphBlendMesh.prototype = Object.assign(Object.create(a.Mesh.prototype), {
        ...
        update: function (delta) {
            for (var i = 0, il = this.animationsList.length; i < il; i++) {
                ...
                var keyframe = animation.start + a.MathUtils.clamp(Math.floor(animation.time / frameTime), 0, animation.length - 1);
