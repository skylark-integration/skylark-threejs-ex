define([
    ...
    var SSAARenderPass = function (scene, camera, clearColor, clearAlpha) {
        ...
        this.fsQuad = new b.Pass.FullScreenQuad(this.copyMaterial);
    };
    SSAARenderPass.prototype = Object.assign(Object.create(b.Pass.prototype), {
        ...
        render: function (renderer, writeBuffer, readBuffer) {
            if (!this.sampleRenderTarget) {
                this.sampleRenderTarget = new a.WebGLRenderTarget(readBuffer.width, readBuffer.height, {
