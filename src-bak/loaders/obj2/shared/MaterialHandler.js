define(['skylark-threejs'], function (a) {
    ...
    MaterialHandler.prototype = {
        ...
        createDefaultMaterials: function (overrideExisting) {
            let defaultMaterial = new a.MeshStandardMaterial({ color: 14479871 });
            defaultMaterial.name = 'defaultMaterial';
            let defaultVertexColorMaterial = new a.MeshStandardMaterial({ color: 14479871 });
            defaultVertexColorMaterial.name = 'defaultVertexColorMaterial';
            defaultVertexColorMaterial.vertexColors = a.VertexColors;
            let defaultLineMaterial = new a.LineBasicMaterial();
            defaultLineMaterial.name = 'defaultLineMaterial';
            let defaultPointMaterial = new a.PointsMaterial({ size: 0.1 });
        ...
        addPayloadMaterials: function (materialPayload) {
            ...
            if (materials !== undefined && materials !== null && Object.keys(materials).length > 0) {
                let loader = new a.MaterialLoader();
                let materialJson;
