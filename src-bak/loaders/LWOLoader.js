define(["skylark-threejs"], function (a) {
    ...
    function printBuffer(buffer, from, to) {
        console.log(a.LoaderUtils.decodeText(new Uint8Array(buffer, from, to)));
    }
    var lwoTree;
    ...
    LWOLoader.prototype = Object.assign(Object.create(a.Loader.prototype), {
    ...
    LWOTreeParser.prototype = {
        ...
        parseMesh(geometry, layer) {
            ...
            if (layer.geometry.type === 'points')
                mesh = new a.Points(geometry, materials);
            else if (layer.geometry.type === 'lines')
                mesh = new a.LineSegments(geometry, materials);
            else
                mesh = new a.Mesh(geometry, materials);
            if (layer.name)
            ...
            if (type === 'points' || type === 'lines') {
                materials.forEach(function (mat, i) {
                    ...
                    if (type === 'points') {
                        ...
                        materials[i] = new a.PointsMaterial(spec);
                    } else if (type === 'lines') {
                        materials[i] = new a.LineBasicMaterial(spec);
                    }
                });
            }
    ...
    MaterialParser.prototype = {
        ...
        parseMaterialLwo2(materialData, name) {
            ...
            params = Object.assign(params, attributes);
            return new a.MeshPhongMaterial(params);
        },
        getSide(attributes) {
            if (!attributes.side)
                return a.BackSide;
            ...
            for (var name in textureNodes) {
                ...
                case 'Normal':
                    ...
                    if (node.amplitude !== undefined)
                        maps.normalScale = new a.Vector2(node.amplitude, node.amplitude);
                    break;
                case 'Bump':
        ...
        parseAttributes(attributes, maps) {
            ...
            if (attributes.undefined && !maps.map) {
                params.color = new a.Color().fromArray(attributes.undefined.value);
            } else
                params.color = new a.Color();
        ...
        parseStandardAttributes(params, attributes, maps) {
            if (attributes.Luminous) {
                ...
                if (attributes['Luminous Color'] && !maps.emissive) {
                    params.emissive = new a.Color().fromArray(attributes['Luminous Color'].value);
                } else {
                    params.emissive = new a.Color(8421504);
                }
            }
        ...
        parsePhongAttributes(params, attributes, maps) {
            ...
            if (!attributes.Roughness && attributes.Specular && !maps.specularMap) {
                if (attributes['Color Highlight']) {
                    params.specular = new a.Color().setScalar(attributes.Specular.value).lerp(params.color.clone().multiplyScalar(attributes.Specular.value), attributes['Color Highlight'].value);
                } else {
                    params.specular = new a.Color().setScalar(attributes.Specular.value);
                }
            }
        ...
        parseEnvMap(connections, maps, attributes) {
            if (connections.envMap) {
                ...
                if (attributes.transparent && attributes.opacity < 0.999) {
                    envMap.mapping = a.EquirectangularRefractionMapping;
                    ...
                    envMap.mapping = a.EquirectangularReflectionMapping;
                maps.envMap = envMap;
            }
        },
        ...
        getWrappingType(num) {
            ...
            case 0:
                ...
                return a.ClampToEdgeWrapping;
            case 1:
                return a.RepeatWrapping;
            case 2:
    ...
    GeometryParser.prototype = {
        ...
        parse(geoData, layer) {
            ...
            geometry.setAttribute('position', new a.Float32BufferAttribute(geoData.points, 3));
        ...
        parseUVs(geometry, layer) {
            ...
            geometry.setAttribute('uv', new a.Float32BufferAttribute(remappedUVs, 2));
        },
        parseMorphTargets(geometry, layer) {
            ...
            for (var name in layer.morphTargets) {
                ...
                geometry.morphAttributes.position[num] = new a.Float32BufferAttribute(remappedPoints, 3);
