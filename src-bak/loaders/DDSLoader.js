define(["skylark-threejs"], function (a) {
    ...
    DDSLoader.prototype = Object.assign(Object.create(a.CompressedTextureLoader.prototype), {
        ...
        parse: function (buffer, loadMipmaps) {
            ...
            case FOURCC_DXT1:
                blockBytes = 8;
                dds.format = a.RGB_S3TC_DXT1_Format;
                break;
            case FOURCC_DXT3:
                blockBytes = 16;
                dds.format = a.RGBA_S3TC_DXT3_Format;
                break;
            case FOURCC_DXT5:
                blockBytes = 16;
                dds.format = a.RGBA_S3TC_DXT5_Format;
                break;
            case FOURCC_ETC1:
                blockBytes = 8;
                dds.format = a.RGB_ETC1_Format;
                break;
            default:
