define(["skylark-threejs"], function (a) {
	...
	`;
        var tempVec0 = new a.Vector3();
        var tempVec1 = new a.Vector3();
        ...
        function createObject(elements, elementSize, isConditionalSegments) {
            ...
            bufferGeometry.setAttribute('position', new a.Float32BufferAttribute(positions, 3));
            if (elementSize === 3) {
                bufferGeometry.setAttribute('normal', new a.Float32BufferAttribute(normals, 3));
            }
            var object3d = null;
            if (elementSize === 2) {
                object3d = new a.LineSegments(bufferGeometry, materials);
            } else if (elementSize === 3) {
                object3d = new a.Mesh(bufferGeometry, materials);
            }
            if (isConditionalSegments) {
                ...
                bufferGeometry.setAttribute('control0', new a.BufferAttribute(controlArray0, 3, false));
                bufferGeometry.setAttribute('control1', new a.BufferAttribute(controlArray1, 3, false));
                bufferGeometry.setAttribute('direction', new a.BufferAttribute(directionArray, 3, false));
            }
            return object3d;
        }
        ...
        LDrawLoader.prototype = Object.assign(Object.create(a.Loader.prototype), {
            ...
            load: function (url, onLoad, onProgress, onError) {
                ...
                var scope = this;
                var fileLoader = new a.FileLoader(this.manager);
            ...
            parseColourMetaDirective: function (lineParser) {
                ...
                case LDrawLoader.FINISH_TYPE_DEFAULT:
                    material = new a.MeshStandardMaterial({
                        color: colour,
                        roughness: 0.3,
                        envMapIntensity: 0.3,
                        metalness: 0
                ...
                case LDrawLoader.FINISH_TYPE_PEARLESCENT:
                    var specular = new a.Color(colour);
                ...
                if (!edgeMaterial) {
                    edgeMaterial = new a.LineBasicMaterial({
                        color: edgeColour,
                    ...
                    edgeMaterial.userData.conditionalEdgeMaterial = new a.ShaderMaterial({
                        vertexShader: conditionalLineVertShader,
                        fragmentShader: conditionalLineFragShader,
                        uniforms: {
                            diffuse: { value: new a.Color(edgeColour) },
                            opacity: { value: alpha }
                        },
                        transparent: isTransparent,
                        depthWrite: !isTransparent
            ...
            objectParse: function (text) {
                ...
                function parseVector(lp) {
                    var v = new a.Vector3(parseFloat(lp.getToken()), parseFloat(lp.getToken()), parseFloat(lp.getToken()));
                ...
                for (lineIndex = 0; lineIndex < numLines; lineIndex++) {
                        ...
                        if (meta) {
                            ...
                            case '!LDRAW_ORG':
                                ...
                                if (isRoot || scope.separateObjects && !isPrimitiveType(type)) {
                                    currentParseScope.groupObject = new a.Group();
                    ...
                    case '1':
                        ...
                        var matrix = new a.Matrix4().set(m0, m1, m2, posX, m3, m4, m5, posY, m6, m7, m8, posZ, 0, 0, 0, 1);
                    ...
                    case '3':
                        ...
                        faceNormal = new a.Vector3().crossVectors(tempVec0, tempVec1).normalize();
                        triangles.push({
                            material: material,
                            colourCode: material.userData.code,
                            v0: v0,
            ...
            processObject: function (text, onProcessed, subobject, url) {
                ...
                function loadSubobject(subobject) {
                    ...
                    var fileLoader = new a.FileLoader(scope.manager);
