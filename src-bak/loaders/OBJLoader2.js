define([
    ...
    './obj2/shared/MeshReceiver.js',
    './obj2/shared/MaterialHandler.js'
], function (a, b, c, d) {
    'use strict';
    const OBJLoader2 = function (manager) {
        a.Loader.call(this, manager);
        this.parser = new b.OBJLoader2Parser();
        this.modelName = '';
        this.instanceNo = 0;
        this.baseObject3d = new a.Object3D();
        this.materialHandler = new d.MaterialHandler();
        this.meshReceiver = new c.MeshReceiver(this.materialHandler);
        let scope = this;
    ...
    OBJLoader2.prototype = Object.assign(Object.create(a.Loader.prototype), {
        ...
        load: function (url, onLoad, onFileLoadProgress, onError, onMeshAlter) {
            ...
            let fileLoader = new a.FileLoader(this.manager);
