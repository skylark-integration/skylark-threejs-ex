define(["skylark-threejs"], function (a) {
    ...
    RGBELoader.prototype = Object.assign(Object.create(a.DataTextureLoader.prototype), {
            ...
            if (RGBE_RETURN_FAILURE !== rgbe_header_info) {
                ...
                if (RGBE_RETURN_FAILURE !== image_rgba_data) {
                    ...
                    case a.UnsignedByteType:
                        ...
                        var format = a.RGBEFormat;
                        var type = a.UnsignedByteType;
                        break;
                    case a.FloatType:
                        ...
                        var data = floatArray;
                        var format = a.RGBFormat;
                        var type = a.FloatType;
                        break;
