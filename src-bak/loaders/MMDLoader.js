define([
    ...
    var MMDLoader = function () {
        function MMDLoader(manager) {
            ...
            this.loader = new a.FileLoader(this.manager);
            this.parser = null;
            this.meshBuilder = new MeshBuilder(this.manager);
            this.animationBuilder = new AnimationBuilder();
        }
        MMDLoader.prototype = Object.assign(Object.create(a.Loader.prototype), {
            ...
            _getParser: function () {
                if (this.parser === null) {
                    if (typeof c.MMDParser === 'undefined') {
                        throw new Error('THREE.MMDLoader: Import MMDParser https://github.com/takahirox/mmd-parser');
                    }
                    this.parser = new c.MMDParser.Parser();
                }
                return this.parser;
            }
        });
        ...
        MeshBuilder.prototype = {
            ...
            build: function (data, resourcePath, onProgress, onError) {
                ...
                var mesh = new a.SkinnedMesh(geometry, material);
                var skeleton = new a.Skeleton(initBones(mesh));
                mesh.bind(skeleton);
                return mesh;
            }
        };
        ...
        GeometryBuilder.prototype = {
            ...
            build: function (data) {
                    ...
                    for (var i = 0; i < data.metadata.ikCount; i++) {
                        ...
                        for (var j = 0, jl = ik.links.length; j < jl; j++) {
                            ...
                            if (data.bones[link.index].name.indexOf('ひざ') >= 0) {
                                link.limitation = new a.Vector3(1, 0, 0);
                            }
                    ...
                    for (var i = 0; i < data.metadata.boneCount; i++) {
                        ...
                        for (var j = 0, jl = ik.links.length; j < jl; j++) {
                            ...
                            if (ik.links[j].angleLimitation === 1) {
                                ...
                                rotationMin[0] = tmp1;
                                rotationMin[1] = tmp2;
                                link.rotationMin = new a.Vector3().fromArray(rotationMin);
                                link.rotationMax = new a.Vector3().fromArray(rotationMax);
                            }
                            param.links.push(link);
                        }
                        iks.push(param);
                ...
                for (var i = 0; i < data.metadata.morphCount; i++) {
                    ...
                    var attribute = new a.Float32BufferAttribute(data.metadata.vertexCount * 3, 3);
                ...
                geometry.setAttribute('normal', new a.Float32BufferAttribute(normals, 3));
                geometry.setAttribute('uv', new a.Float32BufferAttribute(uvs, 2));
                geometry.setAttribute('skinIndex', new a.Uint16BufferAttribute(skinIndices, 4));
                geometry.setAttribute('skinWeight', new a.Float32BufferAttribute(skinWeights, 4));
        ...
        function MaterialBuilder(manager) {
            ...
            this.textureLoader = new a.TextureLoader(this.manager);
            this.tgaLoader = null;
        }
        MaterialBuilder.prototype = {
            ...
            build: function (data, geometry) {
                ...
                for (var i = 0; i < data.metadata.materialCount; i++) {
                    ...
                    params.color = new a.Color().fromArray(material.diffuse);
                    params.opacity = material.diffuse[3];
                    params.specular = new a.Color().fromArray(material.specular);
                    params.emissive = new a.Color().fromArray(material.ambient);
                    params.shininess = Math.max(material.shininess, 0.0001);
                    params.transparent = params.opacity !== 1;
                    params.skinning = geometry.bones.length > 0 ? true : false;
                    params.morphTargets = geometry.morphTargets.length > 0 ? true : false;
                    params.fog = true;
                    params.blending = a.CustomBlending;
                    params.blendSrc = a.SrcAlphaFactor;
                    params.blendDst = a.OneMinusSrcAlphaFactor;
                    params.blendSrcAlpha = a.SrcAlphaFactor;
                    params.blendDstAlpha = a.DstAlphaFactor;
                    if (data.metadata.format === 'pmx' && (material.flag & 1) === 1) {
                        params.side = a.DoubleSide;
                    } else {
                        params.side = params.opacity === 1 ? a.FrontSide : a.DoubleSide;
                    }
                    if (data.metadata.format === 'pmd') {
                        if (material.fileName) {
                            ...
                            if (fileNames.length > 1) {
                                ...
                                params.combine = extension === '.sph' ? a.MultiplyOperation : a.AddOperation;
                            }
                        }
                        ...
                        if (material.envTextureIndex !== -1 && (material.envFlag === 1 || material.envFlag == 2)) {
                            ...
                            params.combine = material.envFlag === 1 ? a.MultiplyOperation : a.AddOperation;
                        }
                    ...
                    materials.push(new a.MeshToonMaterial(params));
                }
                if (data.metadata.format === 'pmx') {
            ...
            _getTGALoader: function () {
                if (this.tgaLoader === null) {
                    ...
                    this.tgaLoader = new b.TGALoader(this.manager);
                }
            ...
            _loadTexture: function (filePath, textures, params, onProgress, onError) {
                ...
                var texture = loader.load(fullPath, function (t) {
                    if (params.isToonTexture === true) {
                        ...
                        t.magFilter = a.NearestFilter;
                        t.minFilter = a.NearestFilter;
                    }
                    t.flipY = false;
                    t.wrapS = a.RepeatWrapping;
                    t.wrapT = a.RepeatWrapping;
                ...
                if (params.sphericalReflectionMapping === true) {
                    texture.mapping = a.SphericalReflectionMapping;
                }
        ...
        AnimationBuilder.prototype = {
            ...
            build: function (vmd, mesh) {
                ...
                return new a.AnimationClip('', -1, tracks);
            },
            buildSkeletalAnimation: function (vmd, mesh) {
                ...
                for (var key in motions) {
                    ...
                    tracks.push(this._createTrack(targetName + '.position', a.VectorKeyframeTrack, times, positions, pInterpolations));
                    tracks.push(this._createTrack(targetName + '.quaternion', a.QuaternionKeyframeTrack, times, rotations, rInterpolations));
                }
                return new a.AnimationClip('', -1, tracks);
            },
            buildMorphAnimation: function (vmd, mesh) {
                ...
                for (var key in morphs) {
                    ...
                    tracks.push(new a.NumberKeyframeTrack('.morphTargetInfluences[' + morphTargetDictionary[key] + ']', times, values));
                }
                return new a.AnimationClip('', -1, tracks);
            },
            buildCameraAnimation: function (vmd) {
                ...
                var tracks = [];
                tracks.push(this._createTrack('target.position', a.VectorKeyframeTrack, times, centers, cInterpolations));
                tracks.push(this._createTrack('.quaternion', a.QuaternionKeyframeTrack, times, quaternions, qInterpolations));
                tracks.push(this._createTrack('.position', a.VectorKeyframeTrack, times, positions, pInterpolations));
                tracks.push(this._createTrack('.fov', a.NumberKeyframeTrack, times, fovs, fInterpolations));
                return new a.AnimationClip('', -1, tracks);
            },
        ...
        CubicBezierInterpolation.prototype = Object.assign(Object.create(a.Interpolant.prototype), {
            ...
            interpolate_: function (i1, t0, t, t1) {
                ...
                if (stride === 4) {
                    ...
                    a.Quaternion.slerpFlat(result, 0, values, offset0, values, offset1, ratio);
                } else if (stride === 3) {
                    for (var i = 0; i !== stride; ++i) {
