define(["skylark-threejs"], function (a) {
    ...
    MD2Loader.prototype = Object.assign(Object.create(a.Loader.prototype), {
            ...
            return function (buffer) {
                ...
                for (var i = 0, l = frames.length; i < l; i++) {
                    ...
                    if (frame.vertices.length > 0) {
                        ...
                        var positionAttribute = new a.Float32BufferAttribute(positions, 3);
                    ...
                    if (frame.normals.length > 0) {
                        ...
                        var normalAttribute = new a.Float32BufferAttribute(normals, 3);
                ...
                geometry.animations = a.AnimationClip.CreateClipsFromMorphTargetSequences(frames, 10);
                return geometry;
            };
        }()
    });
