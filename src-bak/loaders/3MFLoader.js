define(["skylark-threejs"], function (a) {
    ...
    ThreeMFLoader.prototype = Object.assign(Object.create(a.Loader.prototype), {
        ...
        parse: function (data) {
            ...
            function loadDocument(data) {
                ...
                var relsFileText = a.LoaderUtils.decodeText(relsView);
                ...
                for (var i = 0; i < modelPartNames.length; i++) {
                    ...
                    var fileText = a.LoaderUtils.decodeText(view);
            ...
            function buildTexture(texture2dgroup, objects, modelData, textureData) {
                ...
                if (texture2d) {
                    ...
                    texture.encoding = a.sRGBEncoding;
                    switch (texture2d.tilestyleu) {
                    case 'wrap':
                        texture.wrapS = a.RepeatWrapping;
                        break;
                    case 'mirror':
                        texture.wrapS = a.MirroredRepeatWrapping;
                        break;
                    case 'none':
                    case 'clamp':
                        texture.wrapS = a.ClampToEdgeWrapping;
                        break;
                    default:
                        texture.wrapS = a.RepeatWrapping;
                    }
                    ...
                    case 'wrap':
                        ...
                        break;
                    case 'mirror':
                        texture.wrapT = a.MirroredRepeatWrapping;
                        break;
                    case 'none':
                    case 'clamp':
                        texture.wrapT = a.ClampToEdgeWrapping;
                        break;
                    default:
                        texture.wrapT = a.RepeatWrapping;
                    }
                    ...
                    case 'auto':
                        ...
                        texture.minFilter = a.LinearMipmapLinearFilter;
                        break;
                    case 'linear':
                        texture.magFilter = a.LinearFilter;
            ...
            function buildBasematerialsMeshes(basematerials, triangleProperties, modelData, meshData, textureData, objectData) {
                ...
                for (var i = 0, l = keys.length; i < l; i++) {
                    ...
                    geometry.setAttribute('position', new a.Float32BufferAttribute(positionData, 3));
            ...
            function buildTexturedMesh(texture2dgroup, triangleProperties, modelData, meshData, textureData, objectData) {
                ...
                geometry.setAttribute('position', new a.Float32BufferAttribute(positionData, 3));
                geometry.setAttribute('uv', new a.Float32BufferAttribute(uvData, 2));
            ...
            function buildVertexColorMesh(colorgroup, triangleProperties, modelData, meshData) {
                ...
                geometry.setAttribute('position', new a.Float32BufferAttribute(positionData, 3));
                geometry.setAttribute('color', new a.Float32BufferAttribute(colorData, 3));
                var material = new a.MeshPhongMaterial({
                    vertexColors: true,
                    flatShading: true
                });
            ...
            function buildDefaultMesh(meshData) {
                var geometry = new a.BufferGeometry();
                geometry.setIndex(new a.BufferAttribute(meshData['triangles'], 1));
                geometry.setAttribute('position', new a.BufferAttribute(meshData['vertices'], 3));
                var material = new a.MeshPhongMaterial({
                    color: 11184895,
                    flatShading: true
                });
            ...
            function buildBasematerial(materialData, objects, modelData) {
                ...
                if (displaypropertiesid !== null && pbmetallicdisplayproperties[displaypropertiesid] !== undefined) {
                    ...
                    material = new a.MeshPhongMaterial({ flatShading: true });
                }
