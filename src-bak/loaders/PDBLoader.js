define(["skylark-threejs"], function (a) {
    ...
    PDBLoader.prototype = Object.assign(Object.create(a.Loader.prototype), {
        ...
        parse: function (text) {
            ...
            function buildGeometry() {
                var build = {
                    geometryAtoms: new a.BufferGeometry(),
                    geometryBonds: new a.BufferGeometry(),
                    json: {
                        atoms: atoms,
                        bonds: bonds
                    }
                ...
                geometryAtoms.setAttribute('position', new a.Float32BufferAttribute(verticesAtoms, 3));
                geometryAtoms.setAttribute('color', new a.Float32BufferAttribute(colorsAtoms, 3));
                geometryBonds.setAttribute('position', new a.Float32BufferAttribute(verticesBonds, 3));
                return build;
            }
            var CPK = {
                h: [
