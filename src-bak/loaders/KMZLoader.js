define([
    ...
    KMZLoader.prototype = Object.assign(Object.create(a.Loader.prototype), {
        ...
        parse: function (data) {
            ...
            var manager = new a.LoadingManager();
            ...
            if (zip.files['doc.kml']) {
                ...
                if (model) {
                    var loader = new b.ColladaLoader(manager);
