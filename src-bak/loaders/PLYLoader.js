define(["skylark-threejs"], function (a) {
    ...
    PLYLoader.prototype = Object.assign(Object.create(a.Loader.prototype), {
        ...
        parse: function (data) {
            ...
            function postProcess(buffer) {
                ...
                geometry.setAttribute('position', new a.Float32BufferAttribute(buffer.vertices, 3));
                if (buffer.normals.length > 0) {
                    geometry.setAttribute('normal', new a.Float32BufferAttribute(buffer.normals, 3));
                }
                if (buffer.uvs.length > 0) {
                    geometry.setAttribute('uv', new a.Float32BufferAttribute(buffer.uvs, 2));
                }
                if (buffer.colors.length > 0) {
                    geometry.setAttribute('color', new a.Float32BufferAttribute(buffer.colors, 3));
                }
                if (buffer.faceVertexUvs.length > 0) {
                    geometry = geometry.toNonIndexed();
                    geometry.setAttribute('uv', new a.Float32BufferAttribute(buffer.faceVertexUvs, 2));
                }
            ...
            if (data instanceof ArrayBuffer) {
                var text = a.LoaderUtils.decodeText(new Uint8Array(data));
