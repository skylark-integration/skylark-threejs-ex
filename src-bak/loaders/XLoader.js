    ...
    var XLoader = function () {
                        ...
                        for (var i = 0; i < XAnimationInfo.keyFrames.length; i++) {
                            ...
                            if (XAnimationInfo.keyFrames[i].matrix) {
                                ...
                                if (this.putFlags.putPos) {
                                    keyframe.pos = new a.Vector3().setFromMatrixPosition(keyframe.matrix);
                                }
                                if (this.putFlags.putRot) {
                                    keyframe.rot = new a.Quaternion().setFromRotationMatrix(keyframe.matrix);
                                }
                                if (this.putFlags.putScl) {
                                    keyframe.scl = new a.Vector3().setFromMatrixScale(keyframe.matrix);
                                }
                            }
                            keys.push(keyframe);
                        }
        ...
        var XLoader = function () {
            function XLoader(manager) {
                ...
                this.debug = false;
                this.texloader = new a.TextureLoader(this.manager);
                this.url = '';
            ...
            createClass(XLoader, [
                ...
                },
                {
                    ...
                    value: function _ensureString(buf) {
                        if (typeof buf !== 'string') {
                            return a.LoaderUtils.decodeText(new Uint8Array(buf));
                        } else {
                            return buf;
                        }
                    }
                ...
                },
                {
                    ...
                    value: function _parseBinary(data) {
                        return this._parseASCII(a.LoaderUtils.decodeText(new Uint8Array(data)));
                    }
                },
                {
                    key: '_parseASCII',
                    value: function _parseASCII() {
                        ...
                        if (this.resourcePath !== '') {
                            ...
                            path = a.LoaderUtils.extractUrlBase(this.url);
                        }
                ...
                },
                {
                    ...
                    value: function _setFrameTransformMatrix() {
                        this._currentFrame.FrameTransformMatrix = new a.Matrix4();
                ...
                },
                {
                    ...
                    value: function _buildGeometry() {
                        ...
                        bufferGeometry.setAttribute('position', new a.Float32BufferAttribute(position, 3));
                        bufferGeometry.setAttribute('normal', new a.Float32BufferAttribute(normals, 3));
                        bufferGeometry.setAttribute('uv', new a.Float32BufferAttribute(uvs, 2));
                        bufferGeometry.setAttribute('skinIndex', new a.Uint16BufferAttribute(skinIndices, 4));
                        bufferGeometry.setAttribute('skinWeight', new a.Float32BufferAttribute(skinWeights, 4));
                ...
                },
                {
                    ...
                    value: function _setMaterial() {
                        var _nowMat = new a.MeshPhongMaterial({ color: Math.random() * 16777215 });
                        _nowMat.side = a.FrontSide;
                        ...
                        while (true) {
                            if (this._currentObject.children.length > 0) {
                                ...
                                case 'NormalMapFilename':
                                    ...
                                    _nowMat.normalScale = new a.Vector2(2, 2);
                                    break;
                ...
                },
                {
                    ...
                    value: function _setSkinWeights() {
                        ...
                        line = this._currentObject.data.substr(endRead, find - endRead);
                        var data3 = this._readLine(line.trim()).split(',');
                        boneInf.OffsetMatrix = new a.Matrix4();
                    ...
                    value: function _makePutBoneList(_RootName, _bones) {
                        ...
                        for (var frame in this.HieStack) {
                            if (this.HieStack[frame].name === _RootName || putting) {
                                ...
                                b.pos = new a.Vector3().setFromMatrixPosition(b.FrameTransformMatrix).toArray();
                                b.rotq = new a.Quaternion().setFromRotationMatrix(b.FrameTransformMatrix).toArray();
                                b.scl = new a.Vector3().setFromMatrixScale(b.FrameTransformMatrix).toArray();
                        ...
                        if (this._currentGeo.BoneInfs.length > 0) {
                            ...
                            for (var bi = 0; bi < this._currentGeo.BoneInfs.length; bi++) {
                                ...
                                for (var bb = 0; bb < putBones.length; bb++) {
                                    if (putBones[bb].name === this._currentGeo.BoneInfs[bi].boneName) {
                                        boneIndex = bb;
                                        putBones[bb].OffsetMatrix = new a.Matrix4();
                            ...
                            for (var _bi = 0; _bi < putBones.length; _bi++) {
                                if (putBones[_bi].OffsetMatrix) {
                                    ...
                                    offsetList.push(new a.Matrix4());
                                }
                            }
                            var bufferGeometry = this._buildGeometry();
                            mesh = new a.SkinnedMesh(bufferGeometry, this._currentGeo.Materials.length === 1 ? this._currentGeo.Materials[0] : this._currentGeo.Materials);
                            this._initSkeleton(mesh, putBones, offsetList);
                        } else {
                            var _bufferGeometry = this._buildGeometry();
                            mesh = new a.Mesh(_bufferGeometry, this._currentGeo.Materials.length === 1 ? this._currentGeo.Materials[0] : this._currentGeo.Materials);
                        }
                        mesh.name = this._currentGeo.name;
                        var worldBaseMx = new a.Matrix4();
                ...
                },
                {
                    ...
                    value: function _initSkeleton(mesh, boneList, boneInverses) {
                        ...
                        var skeleton = new a.Skeleton(bones, boneInverses);
                    ...
                    value: function _readAnimationKey() {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            if (nowKeyType != 4) {
                                ...
                                switch (nowKeyType) {
                                case 0:
                                    keyInfo.rot = new a.Quaternion(parseFloat(frameValue[1]), parseFloat(frameValue[2]), parseFloat(frameValue[3]), parseFloat(frameValue[0]) * -1);
                                    break;
                                case 1:
                                    keyInfo.scl = new a.Vector3(parseFloat(frameValue[0]), parseFloat(frameValue[1]), parseFloat(frameValue[2]));
                                    break;
                                case 2:
                                    keyInfo.pos = new a.Vector3(parseFloat(frameValue[0]), parseFloat(frameValue[1]), parseFloat(frameValue[2]));
                                    break;
                                }
                                if (!frameFound) {
                ...
                },
                {
                    ...
                    value: function assignAnimation(_model, _animation) {
                        ...
                        model.geometry.animations.push(a.AnimationClip.parseAnimation(put, model.skeleton.bones));
                        if (!model.animationMixer) {
                            model.animationMixer = new a.AnimationMixer(model);
                        }
                        return put;
                    }
                },
