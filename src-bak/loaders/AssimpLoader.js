define(["skylark-threejs"], function (a) {
    ...
    AssimpLoader.prototype = Object.assign(Object.create(a.Loader.prototype), {
        ...
        parse: function (buffer, path) {
            ...
            Virtulous.KeyFrame = function (time, matrix) {
                ...
                this.quaternion = new a.Quaternion();
            ...
            Virtulous.KeyFrame.tempAniPos = new a.Vector3();
            Virtulous.KeyFrame.tempAniQuat = new a.Quaternion();
            Virtulous.KeyFrame.tempAniScale = new a.Vector3(1, 1, 1);
            Virtulous.KeyFrame.tempAniMatrix = new a.Matrix4();
            ...
            function aiMesh() {
                ...
                this.hookupSkeletons = function (scene) {
                    ...
                    var skeleton = new a.Skeleton(allBones, offsetMatrix);
                    this.threeNode.bind(skeleton, new a.Matrix4());
                ...
                this.toTHREE = function (scene) {
                    ...
                    if (scene.mMaterials[this.mMaterialIndex])
                        ...
                        mat = new a.MeshLambertMaterial();
                    geometry.setIndex(new a.BufferAttribute(new Uint32Array(this.mIndexArray), 1));
                    geometry.setAttribute('position', new a.BufferAttribute(this.mVertexBuffer, 3));
                    if (this.mNormalBuffer && this.mNormalBuffer.length > 0)
                        geometry.setAttribute('normal', new a.BufferAttribute(this.mNormalBuffer, 3));
                    if (this.mColorBuffer && this.mColorBuffer.length > 0)
                        geometry.setAttribute('color', new a.BufferAttribute(this.mColorBuffer, 4));
                    if (this.mTexCoordsBuffers[0] && this.mTexCoordsBuffers[0].length > 0)
                        geometry.setAttribute('uv', new a.BufferAttribute(new Float32Array(this.mTexCoordsBuffers[0]), 2));
                    if (this.mTexCoordsBuffers[1] && this.mTexCoordsBuffers[1].length > 0)
                        geometry.setAttribute('uv1', new a.BufferAttribute(new Float32Array(this.mTexCoordsBuffers[1]), 2));
                    if (this.mTangentBuffer && this.mTangentBuffer.length > 0)
                        geometry.setAttribute('tangents', new a.BufferAttribute(this.mTangentBuffer, 3));
                    if (this.mBitangentBuffer && this.mBitangentBuffer.length > 0)
                        geometry.setAttribute('bitangents', new a.BufferAttribute(this.mBitangentBuffer, 3));
                    if (this.mBones.length > 0) {
                        var weights = [];
                        var bones = [];
                        for (var i = 0; i < this.mBones.length; i++) {
                        ...
                        geometry.setAttribute('skinWeight', new a.BufferAttribute(new Float32Array(_weights), BONESPERVERT));
                        geometry.setAttribute('skinIndex', new a.BufferAttribute(new Float32Array(_bones), BONESPERVERT));
                    }
                    var mesh;
                    if (this.mBones.length == 0)
                        mesh = new a.Mesh(geometry, mat);
                    if (this.mBones.length > 0) {
                        mesh = new a.SkinnedMesh(geometry, mat);
            ...
            function aiColor3D() {
                ...
                this.a = 0;
                this.toTHREE = function () {
                    return new a.Color(this.r, this.g, this.b);
                };
            }
            function aiQuaternion() {
                ...
                this.w = 0;
                this.toTHREE = function () {
                    return new a.Quaternion(this.x, this.y, this.z, this.w);
                };
            }
            ...
            function aiMaterial() {
                ...
                this.mProperties = [];
                this.toTHREE = function () {
                    var mat = new a.MeshPhongMaterial();
