define([
    ...
    LightningStrike.prototype.init = function (rayParameters) {
        ...
        this.simplexX = new b.SimplexNoise(this.seedGenerator);
        this.simplexY = new b.SimplexNoise(this.seedGenerator);
        this.simplexZ = new b.SimplexNoise(this.seedGenerator);
