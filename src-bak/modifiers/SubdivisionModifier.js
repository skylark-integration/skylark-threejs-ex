define(["skylark-threejs"], function (a) {
    ...
    SubdivisionModifier.prototype.modify = function (geometry) {
        if (geometry.isBufferGeometry) {
            geometry = new a.Geometry().fromBufferGeometry(geometry);
        } else {
    ...
    (function () {
        ...
        function newFace(newFaces, a, b, c, materialIndex) {
            newFaces.push(new a.Face3(a, b, c, undefined, undefined, materialIndex));
        }
        ...
        SubdivisionModifier.prototype.smooth = function (geometry) {
            ...
            newFaces = [];
            var uv, x0, x1, x2;
            var x3 = new a.Vector2();
            var x4 = new a.Vector2();
            var x5 = new a.Vector2();
