define(["skylark-threejs"], function (a) {
    ...
    (function () {
        var cb = new a.Vector3(), ab = new a.Vector3();
        ...
        SimplifyModifier.prototype.modify = function (geometry, count) {
            ...
            var simplifiedGeometry = new a.BufferGeometry();
            var position = [];
            var index = [];
            ...
            simplifiedGeometry.setAttribute('position', new a.Float32BufferAttribute(position, 3));
