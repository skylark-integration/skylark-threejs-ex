define([
    ...
    NURBSCurve.prototype.getPoint = function (t) {
        ...
        var hpoint = b.NURBSUtils.calcBSplinePoint(this.degree, this.knots, this.controlPoints, u);
        if (hpoint.w != 1) {
    ...
    NURBSCurve.prototype.getTangent = function (t) {
        ...
        var ders = b.NURBSUtils.calcNURBSDerivatives(this.degree, this.knots, this.controlPoints, u, 1);
