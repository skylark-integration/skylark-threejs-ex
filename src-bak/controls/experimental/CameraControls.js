define(["skylark-threejs"], function (a) {
    ...
    var CameraControls = function (object, domElement) {
        ...
        this.update = function () {
            ...
            var quat = new a.Quaternion().setFromUnitVectors(object.up, new a.Vector3(0, 1, 0));
            var quatInverse = quat.clone().inverse();
            var lastPosition = new a.Vector3();
            var lastQuaternion = new a.Quaternion();
            var q = new a.Quaternion();
            var vec = new a.Vector3();
        ...
        var EPS = 0.000001;
        var spherical = new a.Spherical();
        var sphericalDelta = new a.Spherical();
        var scale = 1;
        var panOffset = new a.Vector3();
        var zoomChanged = false;
        var rotateStart = new a.Vector2();
        var rotateEnd = new a.Vector2();
        var rotateDelta = new a.Vector2();
        var panStart = new a.Vector2();
        var panEnd = new a.Vector2();
        var panDelta = new a.Vector2();
        var dollyStart = new a.Vector2();
        var dollyEnd = new a.Vector2();
        var dollyDelta = new a.Vector2();
    ...
    CameraControls.prototype = Object.create(a.EventDispatcher.prototype);
    CameraControls.prototype.constructor = CameraControls;
    var OrbitControls = function (object, domElement) {
        CameraControls.call(this, object, domElement);
        this.mouseButtons.LEFT = a.MOUSE.ROTATE;
        this.mouseButtons.RIGHT = a.MOUSE.PAN;
        this.touches.ONE = a.TOUCH.ROTATE;
        this.touches.TWO = a.TOUCH.DOLLY_PAN;
    };
    OrbitControls.prototype = Object.create(a.EventDispatcher.prototype);
    OrbitControls.prototype.constructor = OrbitControls;
    var MapControls = function (object, domElement) {
        CameraControls.call(this, object, domElement);
        this.mouseButtons.LEFT = a.MOUSE.PAN;
        this.mouseButtons.RIGHT = a.MOUSE.ROTATE;
        this.touches.ONE = a.TOUCH.PAN;
        this.touches.TWO = a.TOUCH.DOLLY_ROTATE;
    };
    MapControls.prototype = Object.create(a.EventDispatcher.prototype);
    ...
    TrackballControls.prototype = Object.create(a.EventDispatcher.prototype);
