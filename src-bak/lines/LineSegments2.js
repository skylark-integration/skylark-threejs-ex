define([
    ...
    LineSegments2.prototype = Object.assign(Object.create(a.Mesh.prototype), {
        ...
        raycast: function () {
            var start = new a.Vector4();
            var end = new a.Vector4();
            var ssOrigin = new a.Vector4();
            var ssOrigin3 = new a.Vector3();
            var mvMatrix = new a.Matrix4();
            var line = new a.Line3();
            ...
            return function raycast(raycaster, intersects) {
                ...
                for (var i = 0, l = instanceStart.count; i < l; i++) {
                    ...
                    var zPos = a.MathUtils.lerp(start.z, end.z, param);
