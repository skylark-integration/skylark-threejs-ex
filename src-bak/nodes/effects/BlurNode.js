define([
    ...
    function BlurNode(value, uv, radius, size) {
        ...
        this.value = value;
        this.uv = uv || new f.UVNode();
        this.radius = radius || new e.Vector2Node(1, 1);
        this.size = size;
        this.blurX = true;
        this.blurY = true;
        this.horizontal = new d.FloatNode(1 / 64);
        this.vertical = new d.FloatNode(1 / 64);
    }
    BlurNode.Nodes = function () {
        var blurX = new c.FunctionNode([
    ...
    BlurNode.prototype = Object.create(b.TempNode.prototype);
    ...
    BlurNode.prototype.copy = function (source) {
        ...
        if (source.size !== undefined)
            this.size = new a.Vector2(source.size.x, source.size.y);
