define([
    ...
    '../../inputs/ColorNode.js',
    '../../inputs/FloatNode.js',
    '../../utils/SpecularMIPLevelNode.js'
], function (a, b, c, d, e, f) {
    'use strict';
    function StandardNode() {
        b.Node.call(this);
        this.color = new d.ColorNode(16777215);
        this.roughness = new e.FloatNode(1);
        this.metalness = new e.FloatNode(0);
    }
    StandardNode.prototype = Object.create(b.Node.prototype);
    ...
    StandardNode.prototype.build = function (builder) {
        ...
        if (builder.isShader('vertex')) {
            ...
            builder.mergeUniform(a.UniformsUtils.merge([
                a.UniformsLib.fog,
                a.UniformsLib.lights
            ]));
            if (a.UniformsLib.LTC_1) {
            ...
            var specularRoughness = new c.ExpressionNode('material.specularRoughness', 'f');
            var clearcoatRoughness = new c.ExpressionNode('material.clearcoatRoughness', 'f');
            var contextEnvironment = {
                roughness: specularRoughness,
                bias: new f.SpecularMIPLevelNode(specularRoughness),
                viewNormal: new c.ExpressionNode('normal', 'v3'),
                worldNormal: new c.ExpressionNode('inverseTransformDirection( geometry.normal, viewMatrix )', 'v3'),
                gamma: true
            };
            var contextGammaOnly = { gamma: true };
            var contextClearcoatEnvironment = {
                roughness: clearcoatRoughness,
                bias: new f.SpecularMIPLevelNode(clearcoatRoughness),
                viewNormal: new c.ExpressionNode('clearcoatNormal', 'v3'),
                worldNormal: new c.ExpressionNode('inverseTransformDirection( geometry.clearcoatNormal, viewMatrix )', 'v3'),
                gamma: true
            };
            if (this.mask)
    ...
    StandardNode.prototype.copy = function (source) {
        b.Node.prototype.copy.call(this, source);
        if (source.position)
