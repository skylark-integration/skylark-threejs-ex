define([
    ...
    function PhongNode() {
        b.Node.call(this);
        this.color = new c.ColorNode(15658734);
        this.specular = new c.ColorNode(1118481);
        this.shininess = new d.FloatNode(30);
    }
    PhongNode.prototype = Object.create(b.Node.prototype);
