define(['./TempNode.js'], function (a) {
    'use strict';
    function InputNode(type, params) {
        params = params || {};
        params.shared = params.shared !== undefined ? params.shared : false;
        a.TempNode.call(this, type, params);
        this.readonly = false;
    }
    InputNode.prototype = Object.create(a.TempNode.prototype);
    ...
    InputNode.prototype.createJSONNode = function (meta) {
        var data = a.TempNode.prototype.createJSONNode.call(this, meta);
