define([
    ...
    function TempNode(type, params) {
        b.Node.call(this, type);
        params = params || {};
        this.shared = params.shared !== undefined ? params.shared : true;
        this.unique = params.unique !== undefined ? params.unique : false;
    }
    TempNode.prototype = Object.create(b.Node.prototype);
    ...
    TempNode.prototype.build = function (builder, output, uuid, ns) {
        ...
        if (this.getShared(builder, output)) {
            ...
            if (isUnique && this.constructor.uuid === undefined) {
                this.constructor.uuid = a.MathUtils.generateUUID();
            }
            ...
            if (builder.analyzing) {
                ...
                return b.Node.prototype.build.call(this, builder, output, uuid);
            } else if (isUnique) {
                data.name = data.name || b.Node.prototype.build.call(this, builder, output, uuid);
                return data.name;
