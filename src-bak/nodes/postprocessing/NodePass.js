define([
    ...
    'use strict';
    function NodePass() {
        b.ShaderPass.call(this);
        this.name = '';
        this.uuid = a.MathUtils.generateUUID();
        this.userData = {};
        this.textureID = 'renderTexture';
        this.input = new d.ScreenNode();
        this.material = new c.NodeMaterial();
        this.needsUpdate = true;
    }
    NodePass.prototype = Object.create(b.ShaderPass.prototype);
    ...
    NodePass.prototype.render = function () {
        ...
        b.ShaderPass.prototype.render.apply(this, arguments);
    };
