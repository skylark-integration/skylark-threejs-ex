define([
    ...
    function BumpMapNode(value, scale) {
        ...
        this.value = value;
        this.scale = scale || new b.FloatNode(1);
        this.toNormalMap = false;
    }
    BumpMapNode.Nodes = function () {
        var dHdxy_fwd = new c.FunctionNode([
        ...
        var perturbNormalArb = new c.FunctionNode([
        ...
        var bumpToNormal = new c.FunctionNode([
    ...
    BumpMapNode.prototype = Object.create(a.TempNode.prototype);
    ...
    BumpMapNode.prototype.generate = function (builder, output) {
        if (builder.isShader('fragment')) {
            if (this.toNormalMap) {
                ...
                this.normal = this.normal || new d.NormalNode();
                this.position = this.position || new e.PositionNode(e.PositionNode.VIEW);
