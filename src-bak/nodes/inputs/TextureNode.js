define([
    ...
    function TextureNode(value, uv, bias, project) {
        ...
        this.value = value;
        this.uv = uv || new b.UVNode();
        this.bias = bias;
        this.project = project !== undefined ? project : false;
    }
    TextureNode.prototype = Object.create(a.InputNode.prototype);
    ...
    TextureNode.prototype.getTexture = function (builder, output) {
        return a.InputNode.prototype.generate.call(this, builder, output, this.value.uuid, 't');
    };
