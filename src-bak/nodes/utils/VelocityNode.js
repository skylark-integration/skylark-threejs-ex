define([
    ...
    function VelocityNode(target, params) {
        b.Vector3Node.call(this);
        this.params = {};
        this.velocity = new a.Vector3();
        this.setTarget(target);
        this.setParams(params);
    }
    VelocityNode.prototype = Object.create(b.Vector3Node.prototype);
    ...
    VelocityNode.prototype.setParams = function (params) {
        ...
        switch (this.params.type) {
        case 'elastic':
            this.moment = new a.Vector3();
            this.speed = new a.Vector3();
            this.springVelocity = new a.Vector3();
            this.lastVelocity = new a.Vector3();
            break;
        }
    };
    VelocityNode.prototype.setTarget = function (target) {
        ...
        this.target = target;
        if (target) {
            this.position = target.getWorldPosition(this.position || new a.Vector3());
            this.oldPosition = this.position.clone();
        }
    };
    VelocityNode.prototype.updateFrameVelocity = function () {
        if (this.target) {
            this.position = this.target.getWorldPosition(this.position || new a.Vector3());
    ...
    VelocityNode.prototype.copy = function (source) {
        b.Vector3Node.prototype.copy.call(this, source);
        if (source.target)
